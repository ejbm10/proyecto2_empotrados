...
(
    ...
    localparam PAD8 = log2ceil(64'h40a0 - 64'h4090); 
    // -------------------------------------------------------
    ...
    // ( 0x4010 .. 0x4020 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 15'h4010   ) begin
    ...
    // ( 0x4060 .. 0x4070 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 15'h4060   ) begin
            src_channel = 9'b000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x4070 .. 0x4080 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 15'h4070   ) begin
            src_channel = 9'b000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x4080 .. 0x4088 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 15'h4080   ) begin
            src_channel = 9'b000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x4090 .. 0x40a0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 15'h4090   ) begin
