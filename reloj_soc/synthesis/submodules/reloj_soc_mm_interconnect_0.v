...
module reloj_soc_mm_interconnect_0 (
	...
	wire  [102:0] cmd_demux_src1_data;                                                                            // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [102:0] crosser_001_out_data;                                                                           // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [102:0] cmd_demux_src2_data;                                                                            // cmd_demux:src2_data -> crosser_002:in_data
	wire          cmd_demux_src2_ready;                                                                           // crosser_002:in_ready -> cmd_demux:src2_ready
	wire   [11:0] cmd_demux_src2_channel;                                                                         // cmd_demux:src2_channel -> crosser_002:in_channel
	...
	wire  [102:0] crosser_002_out_data;                                                                           // crosser_002:out_data -> cmd_mux_002:sink0_data
	...
	wire  [102:0] cmd_demux_src3_data;                                                                            // cmd_demux:src3_data -> crosser_003:in_data
	wire          cmd_demux_src3_ready;                                                                           // crosser_003:in_ready -> cmd_demux:src3_ready
	wire   [11:0] cmd_demux_src3_channel;                                                                         // cmd_demux:src3_channel -> crosser_003:in_channel
	...
	wire  [102:0] crosser_003_out_data;                                                                           // crosser_003:out_data -> cmd_mux_003:sink0_data
	wire          crosser_003_out_ready;                                                                          // cmd_mux_003:sink0_ready -> crosser_003:out_ready
	wire   [11:0] crosser_003_out_channel;                                                                        // crosser_003:out_channel -> cmd_mux_003:sink0_channel
	...
	wire  [102:0] rsp_demux_src0_data;                                                                            // rsp_demux:src0_data -> crosser_004:in_data
	...
	wire  [102:0] crosser_004_out_data;                                                                           // crosser_004:out_data -> rsp_mux:sink0_data
	...
	wire  [102:0] rsp_demux_001_src0_data;                                                                        // rsp_demux_001:src0_data -> crosser_005:in_data
	wire          rsp_demux_001_src0_ready;                                                                       // crosser_005:in_ready -> rsp_demux_001:src0_ready
	wire   [11:0] rsp_demux_001_src0_channel;                                                                     // rsp_demux_001:src0_channel -> crosser_005:in_channel
	...
	wire  [102:0] crosser_005_out_data;                                                                           // crosser_005:out_data -> rsp_mux:sink1_data
	wire          crosser_005_out_ready;                                                                          // rsp_mux:sink1_ready -> crosser_005:out_ready
	wire   [11:0] crosser_005_out_channel;                                                                        // crosser_005:out_channel -> rsp_mux:sink1_channel
	...
	wire  [102:0] rsp_demux_002_src0_data;                                                                        // rsp_demux_002:src0_data -> crosser_006:in_data
	wire          rsp_demux_002_src0_ready;                                                                       // crosser_006:in_ready -> rsp_demux_002:src0_ready
	wire   [11:0] rsp_demux_002_src0_channel;                                                                     // rsp_demux_002:src0_channel -> crosser_006:in_channel
	...
	wire  [102:0] crosser_006_out_data;                                                                           // crosser_006:out_data -> rsp_mux:sink2_data
	wire          crosser_006_out_ready;                                                                          // rsp_mux:sink2_ready -> crosser_006:out_ready
	wire   [11:0] crosser_006_out_channel;                                                                        // crosser_006:out_channel -> rsp_mux:sink2_channel
	...
	wire  [102:0] rsp_demux_003_src0_data;                                                                        // rsp_demux_003:src0_data -> crosser_007:in_data
	wire          rsp_demux_003_src0_ready;                                                                       // crosser_007:in_ready -> rsp_demux_003:src0_ready
	wire   [11:0] rsp_demux_003_src0_channel;                                                                     // rsp_demux_003:src0_channel -> crosser_007:in_channel
	...
	wire  [102:0] crosser_007_out_data;                                                                           // crosser_007:out_data -> rsp_mux:sink3_data
	wire          crosser_007_out_ready;                                                                          // rsp_mux:sink3_ready -> crosser_007:out_ready
	wire   [11:0] crosser_007_out_channel;                                                                        // crosser_007:out_channel -> rsp_mux:sink3_channel
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (CLK_clk_clk),                                   //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_009 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_010 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_011 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
