...
module reloj_soc_mm_interconnect_0 (
	...
	wire  [90:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> NIOSII_debug_mem_slave_agent:cp_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                         // cmd_mux_002:src_data -> MEMORY_s1_agent:cp_data
	...
	wire         cmd_mux_003_src_valid;                                                        // cmd_mux_003:src_valid -> REG_LEDS_s1_agent:cp_valid
	wire  [90:0] cmd_mux_003_src_data;                                                         // cmd_mux_003:src_data -> REG_LEDS_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                        // REG_LEDS_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                      // cmd_mux_003:src_channel -> REG_LEDS_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                // cmd_mux_003:src_startofpacket -> REG_LEDS_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                  // cmd_mux_003:src_endofpacket -> REG_LEDS_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_004_src_valid;                                                        // cmd_mux_004:src_valid -> REG_SWITCHES_s1_agent:cp_valid
	wire  [90:0] cmd_mux_004_src_data;                                                         // cmd_mux_004:src_data -> REG_SWITCHES_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                        // REG_SWITCHES_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                      // cmd_mux_004:src_channel -> REG_SWITCHES_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                // cmd_mux_004:src_startofpacket -> REG_SWITCHES_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                  // cmd_mux_004:src_endofpacket -> REG_SWITCHES_s1_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_005_src_data;                                                         // cmd_mux_005:src_data -> TIMER_s1_agent:cp_data
	...
	wire  [90:0] niosii_debug_mem_slave_agent_rp_data;                                         // NIOSII_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] memory_s1_agent_rp_data;                                                      // MEMORY_s1_agent:rp_data -> router_004:sink_data
	...
	wire         reg_leds_s1_agent_rp_valid;                                                   // REG_LEDS_s1_agent:rp_valid -> router_005:sink_valid
	wire  [90:0] reg_leds_s1_agent_rp_data;                                                    // REG_LEDS_s1_agent:rp_data -> router_005:sink_data
	wire         reg_leds_s1_agent_rp_ready;                                                   // router_005:sink_ready -> REG_LEDS_s1_agent:rp_ready
	wire         reg_leds_s1_agent_rp_startofpacket;                                           // REG_LEDS_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         reg_leds_s1_agent_rp_endofpacket;                                             // REG_LEDS_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         reg_switches_s1_agent_rp_valid;                                               // REG_SWITCHES_s1_agent:rp_valid -> router_006:sink_valid
	wire  [90:0] reg_switches_s1_agent_rp_data;                                                // REG_SWITCHES_s1_agent:rp_data -> router_006:sink_data
	wire         reg_switches_s1_agent_rp_ready;                                               // router_006:sink_ready -> REG_SWITCHES_s1_agent:rp_ready
	wire         reg_switches_s1_agent_rp_startofpacket;                                       // REG_SWITCHES_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         reg_switches_s1_agent_rp_endofpacket;                                         // REG_SWITCHES_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [90:0] timer_s1_agent_rp_data;                                                       // TIMER_s1_agent:rp_data -> router_007:sink_data
	...
	wire         reg_leds_s1_agent_rdata_fifo_src_valid;                                       // REG_LEDS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] reg_leds_s1_agent_rdata_fifo_src_data;                                        // REG_LEDS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         reg_leds_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> REG_LEDS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                            // avalon_st_adapter_003:out_0_valid -> REG_LEDS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                             // avalon_st_adapter_003:out_0_data -> REG_LEDS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                            // REG_LEDS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                            // avalon_st_adapter_003:out_0_error -> REG_LEDS_s1_agent:rdata_fifo_sink_error
	wire         reg_switches_s1_agent_rdata_fifo_src_valid;                                   // REG_SWITCHES_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] reg_switches_s1_agent_rdata_fifo_src_data;                                    // REG_SWITCHES_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         reg_switches_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_004:in_0_ready -> REG_SWITCHES_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                            // avalon_st_adapter_004:out_0_valid -> REG_SWITCHES_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                             // avalon_st_adapter_004:out_0_data -> REG_SWITCHES_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                            // REG_SWITCHES_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                            // avalon_st_adapter_004:out_0_error -> REG_SWITCHES_s1_agent:rdata_fifo_sink_error
	...
	reloj_soc_mm_interconnect_0_router_003 router_004 (
	...
	reloj_soc_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	reloj_soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
